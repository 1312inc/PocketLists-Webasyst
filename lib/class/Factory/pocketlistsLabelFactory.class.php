...
/**
 * Class pocketlistsLabelFactory
 *
 * @method pocketlistsLabelModel getModel()
 * @method pocketlistsLabel createNew()
 */
class pocketlistsLabelFactory extends pocketlistsFactory
{
    protected $entity = 'pocketlistsLabel';
     ...
     * @throws waException
     */
    public function findListsByPocketAndLabel(pocketlistsPocket $pocket, pocketlistsLabel $label)
    {
