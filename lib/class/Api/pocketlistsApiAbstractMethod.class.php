...
abstract class pocketlistsApiAbstractMethod extends waAPIMethod
{
     ...
     * @return array
     */
    public function getError(int $code, $value = null): array
    {
        static $code_errors = [];
        if (!$code_errors) {
            try {
                if (!is_string($value)) {
                    $value = waUtils::toStrArray($value);
                    $value = implode(', ', $value);
                }
                $code_errors = [
                    1001 => sprintf_wp('Invalid data type: “%s” (%s)', 'list_id', $value),
                    1002 => _w('List access denied'),
                    1003 => _w('List not found'),
                    1004 => sprintf_wp('Invalid data type: “%s” (%s)', 'name', $value),
                    1005 => sprintf_wp('Invalid data type: “%s” (%s)', 'sort', $value),
                    1006 => sprintf_wp('Invalid data type: “%s” (%s)', 'rank', $value),
                    1007 => sprintf_wp('Invalid value “%s” (%s)', 'rank', $value),
                    1008 => sprintf_wp('Invalid data type: “%s” (%s)', 'assigned_contact_id', $value),
                    1009 => _w('Assigned contact not found'),
                    1010 => sprintf_wp('Invalid data type: “%s” (%s)', 'repeat_frequency', $value),
                    1011 => sprintf_wp('Invalid data type: “%s” (%s)', 'repeat_interval', $value),
                    1012 => sprintf_wp('Invalid value “%s” (%s)', 'repeat_interval', $value),
                    1013 => sprintf_wp('Invalid data type: “%s” (%s)', 'repeat_occurrence', $value),
                    1014 => sprintf_wp('Invalid data type: “%s” (%s)', 'favorite', $value),
                    1015 => sprintf_wp('Invalid value “%s” (%s)', 'favorite', $value),
                    1016 => sprintf_wp('Invalid data type: “%s” (%s)', 'priority', $value),
                    1017 => sprintf_wp('Invalid value “%s” (%s)', 'priority', $value),
                    1018 => sprintf_wp('Invalid data type: “%s” (%s)', 'note', $value),
                    1019 => sprintf_wp('Invalid data type: “%s” (%s)', 'due_datetime', $value),
                    1020 => sprintf_wp('Invalid value “%s” (%s)', 'due_datetime', $value),
                    1021 => sprintf_wp('Invalid data type: “%s” (%s)', 'due_date', $value),
                    1022 => sprintf_wp('Invalid value “%s” (%s)', 'due_date', $value),
                    1023 => sprintf_wp('Invalid data type: “%s” (%s)', 'client_touch_datetime', $value),
                    1024 => sprintf_wp('Invalid value “%s” (%s)', 'client_touch_datetime', $value),
                    1025 => sprintf_wp('Invalid data type: “%s” (%s)', 'location_id', $value),
                    1026 => _w('Location not found'),
                    1027 => sprintf_wp('Invalid data type: “%s” (%s)', 'uuid', $value),
                    1028 => _w('Item with UUID exists'),
                    1029 => sprintf_wp('Invalid data type: “%s” (%s)', 'pro_label_id', $value),
                    1030 => _w('Label not found'),
                    1031 => sprintf_wp('Invalid data type: “%s” (%s)', 'tags', $value),
                    ...
                    1035 => sprintf_wp('Invalid data type: “%s” (%s)', 'files', $value),
                    1036 => _w('External link must have all parameters specified: app_id, entity_type and entity_id'),
                    1037 => sprintf_wp('Invalid data type: “%s” (%s)', 'app_id', $value),
                    1038 => sprintf_wp('Invalid data type: “%s” (%s)', 'entity_type', $value),
                    1039 => sprintf_wp('Invalid data type: “%s” (%s)', 'entity_id', $value),
                    1040 => sprintf_wp('Invalid data type: “%s” (%s)', 'entity_data', $value),
                    1041 => sprintf_wp('Invalid data type: “%s” (%s)', 'external_links', $value),
                    1042 => _w('Access denied'),
                    1043 => sprintf_wp('Missing required parameter: “%s”.', 'id'),
                    1044 => sprintf_wp('Invalid data type: “%s” (%s)', 'id', $value),
                    1045 => sprintf_wp('Invalid data type: “%s” (%s)', 'status', $value),
                    1046 => sprintf_wp('Invalid value “%s” (%s)', 'status', $value),
                    1047 => _w('Item not found'),
                    1048 => _w('Failed to update'),
                    /* ---- */
                    2001 => sprintf_wp('Invalid data type: “%s” (%s)', 'pocket_id', $value),
                    2002 => _w('Pocket not found'),
                    2003 => _w('Pocket access denied'),
                    2004 => sprintf_wp('Invalid data type: “%s” (%s)', 'type', $value),
                    2005 => sprintf_wp('Invalid value “%s” (%s)', 'type', $value),
                    2006 => sprintf_wp('Invalid data type: “%s” (%s)', 'private', $value),
                    2007 => sprintf_wp('Invalid data type: “%s” (%s)', 'archived', $value),
                    2008 => sprintf_wp('Invalid data type: “%s” (%s)', 'icon', $value),
                    2009 => sprintf_wp('Invalid data type: “%s” (%s)', 'color', $value),
                    2010 => sprintf_wp('Invalid value “%s” (%s)', 'color', $value),
                    ...
                    3003 => sprintf_wp('Invalid data type: “%s” (%s)', 'file_name', $value),
                    3004 => sprintf_wp('Invalid data type: “%s” (%s)', 'file', $value),
                    3005 => _w('Attachment not found'),
                    3006 => sprintf_wp('Invalid data type: “%s” (%s)', 'comment', $value),
                    3007 => _w('Comment with UUID exists'),
                    3008 => _w('Comment not found'),
                    3009 => sprintf_wp('Missing required parameter: “%s”.', 'comment'),
                    3010 => sprintf_wp('Invalid data type: “%s” (%s)', 'location_latitude', $value),
                    3011 => sprintf_wp('Invalid value “%s” (%s)', 'location_latitude', $value),
                    3012 => sprintf_wp('Invalid data type: “%s” (%s)', 'location_longitude', $value),
                    3013 => sprintf_wp('Invalid value “%s” (%s)', 'location_longitude', $value),
                    3014 => sprintf_wp('Invalid data type: “%s” (%s)', 'location_radius', $value),
                    3015 => sprintf_wp('Invalid value “%s” (%s)', 'location_radius', $value),
