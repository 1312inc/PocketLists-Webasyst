...
/**
 * Class pocketlistsDelayedAutomation
 */
class pocketlistsDelayedAutomation extends pocketlistsEntity
{
    const STATUS_NEW = 0;
    ...
    public function getAutomation()
    {
        if ($this->automation === null) {
            $this->automation = pl2()->getEntityFactory(pocketlistsAutomation::class)->findById($this->automation_id);

            if (!$this->automation instanceof pocketlistsAutomation) {
     ...
     * @return pocketlistsDelayedAutomation
     */
    public function setAutomation(pocketlistsAutomation $automation)
    {
