...
/**
 * Class pocketlistsAutomationRuleShopShipping
 */
class pocketlistsAutomationRuleShopShipping extends pocketlistsAutomationRuleShopPayment
{
    ...
    public function match($order)
    {
        ...
        return pocketlistsComparision::compare($order->params['shipping_id'], $this->value, $this->compare);
    }
