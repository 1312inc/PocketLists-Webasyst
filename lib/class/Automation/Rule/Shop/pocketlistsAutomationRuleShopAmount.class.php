...
/**
 * Class pocketlistsAutomationRuleShopAmount
 *
 * @method float getValue()
 * @property float $value
 */
class pocketlistsAutomationRuleShopAmount extends pocketlistsAutomationRuleShop
{
    ...
    public function match($order)
    {
        ...
        return pocketlistsComparision::compare($order->total, $this->value, $this->compare);
    }
...
HTML;
    ...
    public function editHtml()
    {
        ...
        return <<<HTML
{$this->getSelectCompareControl($this->compare, pocketlistsComparision::getTypesGTfirst())}
