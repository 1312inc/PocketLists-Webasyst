...
/**
 * Class pocketlistsAutomationRuleShopAction
 *
 * @method shopWorkflowAction|string getValue()
 * @property shopWorkflowAction $value
 */
class pocketlistsAutomationRuleShopAction extends pocketlistsAutomationRuleShop
{
...
HTML;
     ...
     * @param array $json
     *
     * @return pocketlistsAutomationRuleShopAction
    ...
    public function load(array $json)
    {
        ...
        if (!$this->value instanceof shopWorkflowAction) {
            throw new pocketlistsNoShopActionException(sprintf('No shop action %s', $json['value']));
        }
