...
/**
 * Class pocketlistsAutomationRuleShopState
 *
 * @method array getValue()
 * @property array $value
 */
class pocketlistsAutomationRuleShopState extends pocketlistsAutomationRuleShop
{
    ...
    public function match($order)
    {
        ...
        switch ($this->compare) {
            case pocketlistsComparision::TYPE_EQ:
                return in_array($order->state->getId(), $this->value);

            case pocketlistsComparision::TYPE_NEQ:
                return !in_array($order->state->getId(), $this->value);
